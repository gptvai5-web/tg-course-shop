      ...
      <div className="flex items-center justify-center pt-24 pb-12 px-4">
        ...
        >
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-xl font-display font-bold text-primary">TG COURSE.SHOP</h1>
          </div>

          <div className="text-center mb-8">
            <h2 className="text-2xl font-display font-bold mb-1">Welcome!</h2>
          ...
          <Button
            variant="outline"
            className="w-full h-12 rounded-lg text-sm font-medium gap-3"
